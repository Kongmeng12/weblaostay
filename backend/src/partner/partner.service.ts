...
export class PartnerService {
  ...
  async createRoom(_partnerId: bigint, _roomTypeId: bigint, _dto: CreateRoomDto) {
    throw new BadRequestException('ບໍ່ຮອງຮັບ · Room-level selection is not enabled');
  }

  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  async updateRoom(_partnerId: bigint, _roomId: bigint, _dto: UpdateRoomDto) {
    throw new BadRequestException('ບໍ່ຮອງຮັບ · Room-level selection is not enabled');
  }

  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  async removeRoom(_partnerId: bigint, _roomId: bigint) {
    throw new BadRequestException('ບໍ່ຮອງຮັບ · Room-level selection is not enabled');
  }
